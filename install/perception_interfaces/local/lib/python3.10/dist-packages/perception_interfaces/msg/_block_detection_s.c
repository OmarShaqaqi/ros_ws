...
bool perception_interfaces__msg__block_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("perception_interfaces.msg._block_detection.BlockDetection", full_classname_dest, 57) == 0);
  }
  perception_interfaces__msg__BlockDetection * ros_message = _ros_message;
  {  // color
...
{
  /* NOTE(esteve): Call constructor of BlockDetection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_interfaces.msg._block_detection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BlockDetection");
