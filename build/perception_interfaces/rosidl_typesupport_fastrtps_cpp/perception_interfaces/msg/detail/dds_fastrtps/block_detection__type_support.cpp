...
#include "perception_interfaces/msg/detail/block_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const perception_interfaces::msg::BlockDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  perception_interfaces::msg::BlockDetection & ros_message)
{
  // Member: color
  cdr >> ros_message.color;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = perception_interfaces::msg::BlockDetection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const perception_interfaces::msg::BlockDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<perception_interfaces::msg::BlockDetection *>(
    untyped_ros_message);
...
{
  return &perception_interfaces::msg::typesupport_fastrtps_cpp::_BlockDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_interfaces, msg, BlockDetection)() {
  return &perception_interfaces::msg::typesupport_fastrtps_cpp::_BlockDetection__handle;
}
